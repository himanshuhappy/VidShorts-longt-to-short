...
export const metadata = {
  title: "Sign In – VidShorts",
  description: "Sign in to your VidShorts account and start creating viral clips.",
};
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[oklch(0.09_0.01_270)]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-[oklch(0.65_0.25_280/0.10)] blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-[oklch(0.65_0.22_195/0.08)] blur-[100px]" />
        <div
